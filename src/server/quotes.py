_RANDOM_QUOTES = [
    "spectemur agendo",
    "if you lend someone R100 and never see them again, consider it money well spent",
    "Eppur si muove",
    ...
    "Grandma used to sayÖ'Money is not the key to happiness. If you have money you can always have a key made.'",
    ...
    "'I avoid clichÈs like the plague.'",
    ...
    "'I have not failed. I've just found 10, ways that won't work.' - Thomas Alva Edison",
